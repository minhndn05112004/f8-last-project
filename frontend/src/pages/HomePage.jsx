...
const FeaturedProducts = () => {
  const products = [
    ...
    { name: "Xúc Xích Cao Cấp", image: "/images/sausage.png", badge: "BEST SELLER" },
  ]
...
const NewsSection = () => (
  <section className="py-24 bg-white">
    <div className="container">
      <h2 className="text-4xl font-bold mb-4 text-center text-slate-900">Góc Tin Tức</h2>
      <div className="w-20 h-1 bg-red-600 mx-auto mb-16"></div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* News Item 1: Gordon Ramsay */}
        <div className="flex flex-col group cursor-pointer">
          <div className="relative h-[450px] rounded-3xl overflow-hidden mb-6 shadow-xl">
            <img 
              src="https://images.unsplash.com/photo-1514326640560-7d063ef2aed5?q=80&w=1780&auto=format&fit=crop" 
              alt="Gordon Ramsay" 
            ...
            <div className="absolute bottom-0 left-0 p-8">
               <h3 className="text-white font-bold text-xl leading-tight mb-2">
                 Gordon Ramsay và lời khen về chất lượng thịt của Anthony Shop
               </h3>
        ...
        <div className="flex flex-col group cursor-pointer">
          <div className="relative h-[450px] rounded-3xl overflow-hidden mb-6 shadow-xl">
            ...
            <div className="absolute bottom-0 left-0 p-8">
               <h3 className="text-white font-bold text-xl leading-tight mb-2">
                 Từng miếng thịt được chọn lọc từ nguồn nông sản khỏe mạnh
               </h3>
               <div className="w-12 h-1 bg-red-600"></div>
            </div>
          </div>
...
const Partners = () => {
  const logos = [
    { name: 'KFC', src: 'https://upload.wikimedia.org/wikipedia/sco/thumb/b/bf/KFC_logo.svg/1200px-KFC_logo.svg.png' },
    { name: 'LOTTE', src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Lotte_Group_Logo.svg/1200px-Lotte_Group_Logo.svg.png' },
    { name: 'Jollibee', src: 'https://upload.wikimedia.org/wikipedia/en/thumb/8/82/Jollibee_2011_logo.svg/1200px-Jollibee_2011_logo.svg.png' },
    { name: 'Dookki', src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_L5n7Uf0T5vjX-C0e-ZpG3_L-9-z9z9z9z9&s' }
  ]
