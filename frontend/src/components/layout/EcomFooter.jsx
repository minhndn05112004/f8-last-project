      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <a href="tel:0366585487" className="flex items-center gap-3 mb-4 no-underline group">
              <div className="w-10 h-10 rounded-full bg-red-700/20 flex items-center justify-center text-red-500 group-hover:bg-red-700/30 transition-colors">
              ...
              <div>
                ...
                <p className="text-white font-bold text-lg m-0 group-hover:text-red-500 transition-colors">0366585487</p>
              </div>
            </a>
          </div>
        </div>
